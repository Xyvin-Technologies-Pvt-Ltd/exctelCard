    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 to-orange-100">
      ...
      <div className="max-w-4xl mx-auto p-4 pb-8">
        ...
        <div className="text-center mb-6 mt-4">
          ...
          <p className="text-orange-600 font-medium mb-1">{profile.jobTitle}</p>
        ...
        <div className="space-y-3">
          ...
          <Button
            ...
            className="w-full bg-orange-600 hover:bg-orange-700 text-white py-4 text-lg font-semibold rounded-xl shadow-lg"
          >
          ...
          <div className="grid grid-cols-2 gap-3">
            <Button
              ...
              className="py-3 rounded-xl border-2 border-gray-200 hover:border-orange-300 hover:bg-orange-50"
            >
